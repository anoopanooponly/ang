...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashGet = __webpack_require__(2);
	...
	var ClapprStats = (function (_ContainerPlugin) {
	  ...
	  function ClapprStats(container) {
	    ...
	    _get(Object.getPrototypeOf(ClapprStats.prototype), 'constructor', this).call(this, container);
	    this._runEach = (0, _lodashGet2['default'])(container, 'options.clapprStats.runEach', 5000);
	    this._onReport = (0, _lodashGet2['default'])(container, 'options.clapprStats.onReport', this._defaultReport);
	    this._uriToMeasureLatency = (0, _lodashGet2['default'])(container, 'options.clapprStats.uriToMeasureLatency');
	  ...
	  _createClass(ClapprStats, [{
	    ...
	    value: function bindEvents() {
	      ...
	      this.listenTo(this.container, _clappr.Events.CONTAINER_PAUSE, this.stopReporting);
	    ...
	    value: function onBitrate(newBitrate) {
	      var bitrate = parseInt((0, _lodashGet2['default'])(newBitrate, 'bitrate', 0), 10);
	      var now = this._now();
	    ...
	    value: function _calculateBitrates() {
	      ...
	      this._metrics.extra.bitrateVariance = bitrates.map(function (n) {
	        return Math.pow(n - _this2._metrics.extra.bitrateMean, 2);
	      }).reduce(function (a, b) {
	        return a + b;
	      }, 0) / bitrates.length;
