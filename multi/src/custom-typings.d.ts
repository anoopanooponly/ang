...
declare module 'Clappr' {
 ...
 export class UICorePlugin {
   $el: any;
    constructor(arg: any);
     listenTo(...agrs);
    _onMouseMove(ent: any);
    _onMouseLeave(ent: any);
    _init();
...
declare var ClapprStats: any;
declare var ClickToPausePlugin: any;
declare var stats: any;
declare var ClapprThumbnailsPlugin: any;
declare var url:  any;
declare var P2PHLS: any;
declare var P2PHLSStats: any; 
